...
public class AnswersQuizThree implements Parcelable {

    private String cod_raspuns;
    private int nivel;
    private String drawable_res;

    public AnswersQuizThree() {

    }

    public AnswersQuizThree(String cod_raspuns, int nivel, String drawable_res) {
        this.cod_raspuns = cod_raspuns;
        this.nivel = nivel;
        this.drawable_res = drawable_res;
    }

    protected AnswersQuizThree(Parcel in) {
