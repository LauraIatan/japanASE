...
public class QuestionQuizOne implements Parcelable {
    ...
    public QuestionQuizOne() {
    }

    public QuestionQuizOne(String cod_raspuns_corect, int nivel, String drawable_res) {
        this.cod_raspuns_corect = cod_raspuns_corect;
        this.nivel = nivel;
        this.drawable_res = drawable_res;
    }

    protected QuestionQuizOne(Parcel in) {
